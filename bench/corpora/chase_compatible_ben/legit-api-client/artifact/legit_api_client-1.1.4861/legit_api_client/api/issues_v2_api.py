...
class IssuesV2Api:
    ...
    def get_issues_count(
        ...
        status_changed_from_date: Annotated[Optional[datetime], Field(description="Filter issues whose status last changed on or after the given date. Time should be in ISO 8601 format (e.g., 2024-05-01T15:00:00+00:00)")] = None,
        status_changed_to_date: Annotated[Optional[datetime], Field(description="Filter issues whose status last changed on or before the given date. Time should be in ISO 8601 format (e.g., 2024-05-01T15:00:00+00:00)")] = None,
        ...
        :param status_changed_from_date: Filter issues whose status last changed on or after the given date. Time should be in ISO 8601 format (e.g., 2024-05-01T15:00:00+00:00)
        :type status_changed_from_date: datetime
        :param status_changed_to_date: Filter issues whose status last changed on or before the given date. Time should be in ISO 8601 format (e.g., 2024-05-01T15:00:00+00:00)
        :type status_changed_to_date: datetime
    ...
    def _get_issues_count_serialize(
        ...
        if status_changed_from_date is not None:
            if isinstance(status_changed_from_date, datetime):
                _query_params.append(
                    (
                        'statusChangedFromDate',
                        status_changed_from_date.strftime(
                            self.api_client.configuration.datetime_format
                        )
                    )
                )
        ...
        if status_changed_to_date is not None:
            if isinstance(status_changed_to_date, datetime):
                _query_params.append(
                    (
                        'statusChangedToDate',
                        status_changed_to_date.strftime(
                            self.api_client.configuration.datetime_format
                        )
                    )
                )
